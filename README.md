...
- [Gravity Swarm MCP](https://github.com/antoinedelorme/gravity-swarm-mcp)![stars](https://img.shields.io/github/stars/antoinedelorme/gravity-swarm-mcp.svg?style=social) - MCP server for an agent reputation network using Nostr BIP-340 signing. AI agents enlist, compute deterministic tasks, answer questions, submit proofs, and earn ELO — all with Nostr-compatible identities.
