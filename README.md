...
- [nostash - nostr signer extension](https://github.com/tyiu/nostash) - an up-to-date and maintained fork of nostore by @tyiu. Nostash is a Safari browser extension for signing events on 3rd party sites without sharing your private keys with them
