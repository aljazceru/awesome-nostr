...
- [BlazeJump](https://github.com/objectwizard/BlazeJump)![stars](https://img.shields.io/github/stars/BrightonBTC/bija.svg?style=social) - A fast web client boilerplate written in C# / Blazor, that uses an in-browser SQLite database.
