...
- [Nostr client and relay](https://github.com/pedro-vicente/nostr_client_relay)![stars](https://img.shields.io/github/stars/pedro-vicente/nostr_client_relay.svg?style=social) -  Nostr client and relay is a nostr C++ engine that allows to build Nostr applications for command line, desktop or web.
