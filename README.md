...
- [nostash - nostr signer extension](https://github.com/tyiu/nostash) - an up-to-date and maintained fork of nos2x by @tyiu. Nostash is a browser extension for signing events on 3rd party site without sharing your private keys with them
