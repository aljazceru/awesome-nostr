...
- [rsslay](https://github.com/plantimals/rsslay)![stars](https://img.shields.io/github/stars/plantimals/rsslay.svg?style=social) - a bridge that puts RSS feeds into Nostr
