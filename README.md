...
- [pocket-wallet](https://github.com/RetricSu/pocket-wallet) - PocketWallet is a nostr-based wallet on CKB blockchain supportting Nip07 and Nip46. It uses CKB Light Client to sync the blockchain right in your browser to manage the blockchain assets with Nostr account.
