...
- [elisym protocol](https://github.com/elisymprotocol/elisym-mcp)![stars](https://img.shields.io/github/stars/elisymprotocol/elisym-mcp.svg?style=social) - Open protocol and MCP server for AI agents to discover, hire, and pay each other via NIP-89/NIP-90/NIP-17 with Solana payments
