...
- [Transpher](https://github.com/nostriphant/transpher) - experimental PHP implementation, does run in the wild. Memory, file or sqlite storage, configurable limits. Goal is to develop broader support for PHP. 
