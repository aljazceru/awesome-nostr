...
- [milo-nostr-dvm-directory](https://github.com/miloantaeus/milo-nostr-dvm-directory)![stars](https://img.shields.io/github/stars/miloantaeus/milo-nostr-dvm-directory.svg?style=social) - Searchable Nostr Data Vending Machine (NIP-90) index — crawls, classifies, and surfaces active DVMs by capability. MIT.
- [milo-nostr-pow-dvm](https://github.com/miloantaeus/milo-nostr-pow-dvm)![stars](https://img.shields.io/github/stars/miloantaeus/milo-nostr-pow-dvm.svg?style=social) - NIP-90 Data Vending Machine that mines NIP-13 PoW for events. Pay-per-mine via Lightning. Bridges mobile users (battery-limited) with always-on mining hardware. Pricing 10-1000 sats per difficulty bit. MIT.
- [milo-nostr-zap-tax-report](https://github.com/miloantaeus/milo-nostr-zap-tax-report)![stars](https://img.shields.io/github/stars/miloantaeus/milo-nostr-zap-tax-report.svg?style=social) - Pull your year's NIP-57 zap receipts → categorize → export tax-ready CSV (with USD prices at receipt time via CoinGecko). Free 30d window; Lightning-paid full-year (500 sats). NOT financial advice. MIT.
