...
- [nostr-relay](https://github.com/avlo/nostr-relay)![stars](https://img.shields.io/github/stars/avlo/nostr-relay.svg?style=social) - Java Nostr-Relay Framework & Web Application.  Java 20, Spring WebSocketSession 3.2.2, Spring Boot 3.2.4, atop [nostr-java library](https://github.com/tcheeric/nostr-java).  Simple. Clean. OO.
